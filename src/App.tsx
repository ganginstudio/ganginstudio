...
import { KakaoTalkIcon, NaverBlogIcon, InstagramIcon } from './components/BrandIcons';
      ...
      <div id="sticky-cta-hub" className="relative z-40">
        ...
        <div id="desktop-fixed-cta" className="hidden sm:flex flex-col fixed bottom-24 right-8 space-y-2 z-50">
          ...
          <a
            ...
            title="카카오톡 1:1 채팅"
          >
            <KakaoTalkIcon size={18} className="group-hover:scale-105 transition-transform" />
          ...
          <a
            ...
            title="인스타그램 방문"
          >
            <InstagramIcon size={18} className="group-hover:scale-105 transition-transform" />
          ...
          <a
            ...
            title="공식 블로그 칼럼"
          >
            <NaverBlogIcon size={18} className="group-hover:scale-105 transition-transform" />
